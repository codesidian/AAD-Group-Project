...
def generateSalesReport(userid,fromDate,toDate):
    ...
    print("Sales Report Generated by user "+str(userid))
    wb.save("Sales_Report"+str(timezone.date.now().strftime("%Y%m%d-%H%M%S"))+".xlsx")
...
def generateReturnsReport(userid,fromDate,toDate):
    ...
    for ret in periodOfReturns:
        ...
        ws1.append(currentRow)
    print("Returns Report Generated by user "+str(userid))
    wb.save("Return_Report"+str(timezone.date.now().strftime("%Y%m%d-%H%M%S"))+".xlsx")
...
def generateStockReport(userid, includeChecks, fromDate = "", toDate = ""):
    ...
    if includeChecks:
        ...
        for check in StockCheck.objects.filter(datetime__range=[fromDate, toDate]):
            ...
            ws2.append(currentRow)
    print("Stock Report Generated by user "+str(userid))
    wb.save("Stock_Report"+str(timezone.date.now().strftime("%Y%m%d-%H%M%S"))+".xlsx")
